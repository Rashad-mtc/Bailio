...
export function PortalShell({ children, role = "proprietaire" }: PortalShellProps) {
  ...
  const tenantLinks = [["⌂", "Mon logement", "/locataire/dashboard"], ["₣", "Payer mon loyer", "/locataire/loyer"], ["◉", "Facture SONEB", "/locataire/soneb"], ["⚡", "Recharge SBEE", "/locataire/sbee"], ["⚑", "Signaler un problème", "/locataire/signaler"]];
